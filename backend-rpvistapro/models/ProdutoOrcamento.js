// models/ProdutoOrcamento.js — Componentes para orçamentos (evento, obra, serviço)
import mongoose from "mongoose";

const ProdutoOrcamentoSchema = new mongoose.Schema(
  {
...
ProdutoOrcamentoSchema.index({ empresa: 1, categoria: 1 });

export default mongoose.model("ProdutoOrcamento", ProdutoOrcamentoSchema, "produtoeventos");
